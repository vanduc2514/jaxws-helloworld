...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://jaxws/", "sayHelloWorldFrom");
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://jaxws/", "sayHelloWorldFromResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws/", name = "sayHelloWorldFrom")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws/", name = "sayHelloWorldFromResponse")
